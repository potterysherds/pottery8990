...
EXTERNAL_DRIVE_ADDR = "/mnt/usb/ENGS90Photos"
...
def one_sherd_photo_cycle():
    ...
    if os.path.isdir(EXTERNAL_DRIVE_ADDR) == False:
        print("External drive is not available or file directory is elsewhere!")
    save_location = EXTERNAL_DRIVE_ADDR + "/" + folder_name
