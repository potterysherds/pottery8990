...
def captureImages(dir_and_name = ""):
    if (len(dir_and_name) == 0):
        ...
        os.system('killall -s USR1 gphoto2')
        
def initCaptureProcs(dir_and_name = ""):
    ...
    for i in range(len(ports)):
        ...
        os.system('gphoto2 '+captureCommand + port + 'usb:' + ports[i] + ' --filename="'+dir_and_name+str(i+1)+suffix+'"' + ' --interval -1 &')
